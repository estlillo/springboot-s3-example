package com.barbatos.s3.controller;
...
import com.barbatos.s3.service.api.AWSS3Service;
...
public class UploadFileController {
	...
	public ResponseEntity<String> delete(@RequestParam("key") String key) {
		...
		return new ResponseEntity<String>("El archivo "+key+" fue eliminado correctamente de S3", HttpStatus.OK);
	}
}
